...
Treat `PRODUCT_SPEC.md` and `DOMAIN_MODEL.md` as source of truth.
...
```text
Read docs/PRODUCT_SPEC.md and docs/DOMAIN_MODEL.md first. Treat their MVP decisions as frozen.

Implement Vertical Slice 1 from docs/MVP_PLAN.md only:
- create Space;
