...
**Spec:** [`../specs/PROVIDER_INTEGRATION_SPEC.md`](../specs/PROVIDER_INTEGRATION_SPEC.md)

**Normative guardrails:** [`../specs/PROVIDER_INTEGRATION_GUARDRAILS.md`](../specs/PROVIDER_INTEGRATION_GUARDRAILS.md)

**Post-integration roadmap:** [`./V1_ROADMAP.md`](./V1_ROADMAP.md)
**Next phase:** [`../specs/PRODUCTIZATION_SPEC.md`](../specs/PRODUCTIZATION_SPEC.md)
...
[`../specs/PROVIDER_INTEGRATION_GUARDRAILS.md`](../specs/PROVIDER_INTEGRATION_GUARDRAILS.md).
...
1. Read:
   ...
   - `docs/specs/PROVIDER_INTEGRATION_GUARDRAILS.md`;
...
**Implementation status:** Complete and Frozen. The native hook bridge, daemon lifecycle route, bootstrap injection, Conversation-lite capture, fail-open behavior, lifecycle eval, and real Codex CLI smoke passed. Evidence: [`../reports/validation/CODEX_P2_SMOKE.md`](../reports/validation/CODEX_P2_SMOKE.md).
...
**Normative execution spec:** [`../specs/P4_CROSS_SESSION_PROVIDER_EVAL.md`](../specs/P4_CROSS_SESSION_PROVIDER_EVAL.md)
**Review:** [`../reviews/CR-PHASE7.md`](../reviews/CR-PHASE7.md)
...
- [`../specs/PRODUCTIZATION_SPEC.md`](../specs/PRODUCTIZATION_SPEC.md)
- [`../specs/MEMORY_QUALITY_V1_SPEC.md`](../specs/MEMORY_QUALITY_V1_SPEC.md)
- [`../specs/P7_IMPLICIT_RECALL_SPEC.md`](../specs/P7_IMPLICIT_RECALL_SPEC.md)
...
See `../specs/PRODUCTIZATION_SPEC.md` rather than expanding Provider Integration code for those concerns.
