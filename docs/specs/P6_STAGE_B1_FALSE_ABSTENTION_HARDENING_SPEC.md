...
**Depends on:** `./P6_STAGE_B_RETRIEVAL_SPEC.md`, `../reviews/CR-PHASE10.md`, `../reports/quality/P6_STAGE_B1_RESULT.md`
...
docs/specs/P6_STAGE_B1_FALSE_ABSTENTION_HARDENING_SPEC.md
docs/specs/P6_STAGE_B_RETRIEVAL_SPEC.md    status/reference update only
docs/reports/quality/P6_STAGE_B1_RESULT.md   final evidence update
docs/reviews/*                       reviewer-owned status unless explicitly requested
