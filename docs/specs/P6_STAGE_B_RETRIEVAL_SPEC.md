...
**Depends on:** `./MEMORY_QUALITY_V1_SPEC.md`, `../reports/quality/P6_BASELINE.md`, `../reviews/CR-PHASE9.md`, `../reviews/CR-PHASE10.md`, `./P6_STAGE_B1_FALSE_ABSTENTION_HARDENING_SPEC.md`, `./P6_STAGE_B1_TWO_TOKEN_CONFLICT_HARDENING_SPEC.md`
...
[`../reports/quality/P6_STAGE_B1_RESULT.md`](../reports/quality/P6_STAGE_B1_RESULT.md). Stage B1 is
...
docs/specs/MEMORY_QUALITY_V1_SPEC.md
docs/plans/V1_ROADMAP.md
docs/reports/quality/P6_BASELINE.md        // baseline remains historical; append B1 reference only if useful
README.md
eval/README.md
```
...
```text
docs/reports/quality/P6_STAGE_B1_RESULT.md
```
