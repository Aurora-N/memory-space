...
**Parent spec:** `docs/specs/P6_STAGE_B3_CORE_HANDOFF_POLICY_SPEC.md`
...
docs/reports/quality/P6_STAGE_B3_RESULT.md only after all acceptance gates pass
docs/specs/P6_STAGE_B3_CORE_HANDOFF_POLICY_SPEC.md status/evidence only after review
```
