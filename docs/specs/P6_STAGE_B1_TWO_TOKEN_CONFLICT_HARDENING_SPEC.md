...
**Depends on:** `./P6_STAGE_B_RETRIEVAL_SPEC.md`, `./P6_STAGE_B1_FALSE_ABSTENTION_HARDENING_SPEC.md`, `../reviews/CR-PHASE10.md`, `../reports/quality/P6_STAGE_B1_RESULT.md`
...
docs/specs/P6_STAGE_B1_TWO_TOKEN_CONFLICT_HARDENING_SPEC.md
docs/reports/quality/P6_STAGE_B1_RESULT.md       evidence update only
```
