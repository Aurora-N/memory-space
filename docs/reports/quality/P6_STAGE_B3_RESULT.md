...
**Source of Truth:** `docs/specs/P6_STAGE_B3_CORE_HANDOFF_POLICY_SPEC.md`
**Hardening Source of Truth:** `docs/specs/P6_STAGE_B3_HANDOFF_WORKING_STATE_PROVENANCE_HARDENING_CR_SPEC.md`
